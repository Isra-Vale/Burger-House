    ...
    >
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-400">Sign in to your Burger House account</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-8 space-y-6 glass-card">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute text-gray-500 -translate-y-1/2 right-3 top-1/2 hover:text-white"
              >
          ...
          >
             {isSubmitting ? <Spinner size="sm" /> : <>Sign In <ArrowRight className="w-4 h-4" /></>}
          </button>

          <p className="text-sm text-center text-gray-400">
            Don't have an account?{' '}
            <Link to="/register" className="transition-colors text-burger-orange hover:text-burger-yellow">
              Create one
            </Link>
          </p>
        </form>
